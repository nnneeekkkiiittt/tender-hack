...
class ContextCard(BaseModel):
    ...
    sources_found: List[Dict[str, Any]] = Field(default_factory=list, description="Использованные фрагменты БЗ")
    escalation_reason: Optional[str] = Field(default=None, description="Причина эскалации (дизлайк / нет в БЗ / L3 инцидент)")
