...
export function AdminUsersPage() {
  ...
  const {
    ...
    queryFn: () => listUsers(search, offset),
  })
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
      ...
      <div className="mt-6">
        <SearchInput
          ...
          placeholder={
            isDemoMode
              ? 'Поиск по имени, организации или email...'
                    ...
                    {isDemoMode ? (
                      <>
                        ...
                        <td className="px-4 py-3.5 text-ink-muted">
                          {u.lastActivity ? formatShortDate(u.lastActivity) : '—'}
                        </td>
                      ...
                      <td className="px-4 py-3.5">
                        <Button variant="outline" size="sm" onClick={() => setResetId(u.id)}>
                          Сбросить пароль
                        </Button>
                      </td>
                    )}
